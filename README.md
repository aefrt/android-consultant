...
2. Влад. Сделать чат с учетом замечаний Владислава. Экран 5–6: сделать выделения жирным внутри основного текста и нормальную разметку. Реализовывать надо с помощью Activity или всплывающих окон?
